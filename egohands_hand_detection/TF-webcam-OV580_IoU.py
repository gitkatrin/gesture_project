...
image_array = np.zeros((800,1280,3),np.uint8)
...
for i in range(0,10000000):
    camera = TestLib.OV580Camera_getCamImage3Ch(ctypes.byref(handle),np.ctypeslib.as_ctypes(image_array))
...
#while True:
    ...
    #frame = image_array
    frame = imutils.resize(image_array, width=800)
