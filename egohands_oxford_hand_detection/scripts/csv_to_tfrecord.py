...
def main():
    for directory in ['test']:
        ...
        csv_path = os.path.join(os.getcwd(), './annotations/{}_labels_egohands_oxford.csv'.format(directory,directory))
        output_path = os.path.join(os.getcwd(), './annotations/{}.record'.format(directory))
        label_map_dict = label_map_util.get_label_map_dict(os.path.join(os.getcwd(), './annotations/label_map.pbtxt'))
